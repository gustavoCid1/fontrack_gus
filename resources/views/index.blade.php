                ...
                <tbody>
                    @foreach($usuarios as $usuario)
                        <tr data-id="{{ $usuario->id_usuario }}">
                            ...
                            <td>
                                <button class="btn btn-info btnVer" data-id="{{ $usuario->id_usuario }}"><i
                                        class="bi bi-eye"></i></button>
                                <button class="btn btn-warning btnEditar" data-id="{{ $usuario->id_usuario }}"><i
                                        class="bi bi-pencil"></i></button>
                                <button class="btn btn-danger btnEliminar" data-id="{{ $usuario->id_usuario }}"><i
