                    ...
                    @foreach($materiales as $material)
                        <tr data-id="{{ $material->id_material }}">
                            ...
                            <td class="d-flex flex-column flex-md-row">
                                <button class="btn btn-info btnVer" data-id="{{ $material->id }}" data-bs-toggle="modal"
                                    data-bs-target="#modalVer">Ver</button>
                                <button class="btn btn-warning btnEditar" data-id="{{ $material->id }}"
                                    data-bs-toggle="modal" data-bs-target="#modalRegistro">Editar</button>

                                <button class="btn btn-danger btn-sm btnEliminar"
                                    data-id="{{ $material->id }}">Eliminar</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
